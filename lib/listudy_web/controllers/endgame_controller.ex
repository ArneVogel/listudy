defmodule ListudyWeb.EndgameController do
  ...
  defp endgames do
    %{
      "basic" => %{
        ...
        endgames: %{
          "q" => %{name: gettext("Queen"), games: [["8/2k5/8/8/3KQ3/8/8/8 w - - 0 1", "w"], ["8/2k5/8/8/3KQ3/8/8/8 w - - 0 1", "w"]]},
  ...
  def game(conn, %{"chapter" => chapter, "subchapter" => subchapter, "game" => game}) do
    ...
    render(conn, "game.html", game: game, next: next, chapter: chapter, subchapter: subchapter)
  end
